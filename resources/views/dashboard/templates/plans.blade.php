...
<body style="background-image: url(/assets/images/bgPayment.jpg);background-size: cover;background-position: 50%;background-repeat: no-repeat;">
<script>
...
<main class="Main" id="app">
    <!-- navbar -->
    @include('dashboard.partials.simpleNavbar')
