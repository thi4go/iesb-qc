        ...
        <div class="panel-heading m-b-15">
            <div class="row">
                ...
                <div class="col-xs-4 text-right">
                    ...
                    <a href="{{ route('painel.users.create') }}" class="btn btn-success" title="Adicionar">Adicionar</a>
                    @endif
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="v-align-middle text-right">
                                <a href="{{ route('painel.users.edit', $result->id) }}" class="btn btn-success btn-xs" title="Editar">Editar</a>
                                <a data-id="{{ $result->id }}" data-toggle="modal" data-target="#confirm-delete" data-href="{{ route('painel.users.destroy', $result->id) }}" class="btn btn-danger btn-xs" title="Excluir">Excluir</a>
                            </td>
                            @endif
                        </tr>
                        @endforeach
