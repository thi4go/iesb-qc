...
class ActivityLog extends Model
{
     ...
     * @return string
     */
    public function getUserAgentPreviewAttribute()
    {
     ...
     * @return string
     */
    public function getIconMarkupAttribute()
    {
    ...
    {
        if (is_null($this->getUrl()) || $this->action == 'delete')
            return $this->details;

        return '<a href="'.$this->getUrl().'"><b>'.$this->details.'</b></a>' . "\n";
    }
